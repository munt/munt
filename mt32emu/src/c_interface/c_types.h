...
typedef struct mt32emu_midi_receiver_o mt32emu_midi_receiver_o;
...
typedef struct {
	...
	void (*handleShortMessage)(const mt32emu_midi_receiver_o *instance, const mt32emu_bit32u message);

	/** Invoked when a complete well-formed System Exclusive MIDI message is parsed in the input MIDI stream. */
	void (*handleSysex)(const mt32emu_midi_receiver_o *instance, const mt32emu_bit8u stream[], const mt32emu_bit32u length);

	/** Invoked when a System Realtime MIDI message is parsed in the input MIDI stream. */
	void (*handleSystemRealtimeMessage)(const mt32emu_midi_receiver_o *instance, const mt32emu_bit8u realtime);
...
typedef union {
	mt32emu_interface interface;
	mt32emu_midi_receiver_i_v0 v0;
} mt32emu_midi_receiver_i;

/** Instance of MIDI receiver object */
struct mt32emu_midi_receiver_o {
	/* Interface */
	const mt32emu_midi_receiver_i *i;
	/* User data for this instance */
	void *d;
};
...
typedef struct mt32emu_synth_o mt32emu_synth_o;
...
typedef struct {
	...
	mt32emu_midi_receiver_version (*setMIDIReceiver)(mt32emu_const_context context, const mt32emu_midi_receiver_o *midi_receiver);
