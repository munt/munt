...
public:
	...
	void createContext(mt32emu_report_handler_i report_handler = NULL_REPORT_HANDLER, void *instance_data = NULL) { if (c != NULL) mt32emu_free_context(c); c = mt32emu_create_context(report_handler, instance_data); }
